...
def greet_user(name: str) -> None:
    ...
    if name.startswith("User_"):
        ...
        greeting_text = f"Hello {name}, welcome to ADA, your personal digital assistant."
    ...
    try:
        ...
        greeting_thread = threading.Thread(target=play_greeting_async, args=(temp_filename,))
