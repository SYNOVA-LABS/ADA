...
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "User_Detection"))
        ...
        if detected_user:
            ...
            while True:
                ...
                if time_elapsed < greeting_duration:
                    ...
                    cv2.putText(frame, f"Welcome, {detected_user}!", (20, 50), 
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
                    cv2.putText(frame, "ADA system is ready", (20, 80), 
